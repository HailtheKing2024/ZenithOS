...
install -D -m 0644 "$repo_root/workstation/config/systemd/system/zenith-snapshot-init.service" "$defaults_root/etc/systemd/system/zenith-snapshot-init.service"
...
install -D -m 0755 "$repo_root/workstation/config/usr/lib/zenith/zenith-snapshot" "$defaults_root/usr/lib/zenith/zenith-snapshot"
install -D -m 0644 "$repo_root/workstation/apps/desktop/os.zenith.Snapshots.desktop" "$defaults_root/usr/share/applications/os.zenith.Snapshots.desktop"
