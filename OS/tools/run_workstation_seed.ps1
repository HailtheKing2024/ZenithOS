param(
    [ValidateSet("direct", "splash", "iso", "fast", "persistent")]
    [string]$Mode = "direct",
    [switch]$Wait,
    [switch]$DryRun
)
...
$LiveArgs = "boot=live username=zenith hostname=zenithos locales=en_US.UTF-8 keyboard-layouts=us console=tty0 console=ttyS0,115200n8 systemd.show_status=1 loglevel=4 plymouth.enable=0 zenith.boot_report=1 zenith.profile=dev-vm"
$SplashArgs = "boot=live username=zenith hostname=zenithos locales=en_US.UTF-8 keyboard-layouts=us quiet splash loglevel=3 systemd.show_status=0 plymouth.ignore-serial-consoles zenith.profile=dev-vm"
